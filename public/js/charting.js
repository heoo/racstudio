...
function getmatter(){
    ...
    $.ajax({
        url: uri+"/index/getinfo/get_matter",
        data: {
            pagenum: pagenums,
            zyoption: zyoption,
            xmoption: xmoption,
        ...
        success: function (data) {
            ...
            for (i in infoData) {
                ...
                str+='<div  imgdetailid='+infoData[i]["id"]+' onclick="alertworksdiv(this)" detail_text=\''+infoData[i]["detail_text"]+'\'  showimgfile="'+infoData[i]["imgfile"]+'" showgetcodes="'+infoData[i]["getcodes"]+'">';
                str+='<div class="logoimg" style="border-bottom:1px #f5f5f5 solid;">';

                str+='<img showheight="'+infoData[i]["topimg_height"]+'" showwidth="'+infoData[i]["topimg_width"]+'" src="'+uri+'/public/downimg/'+infoData[i]["img_top"]+'" width="266" style="border:none;"/>';
...
function get_recommend_matter(){
    ...
    $.ajax({
        url: uri+"/index/getinfo/get_recommend_matter",
        data: {
        ...
        success: function (data) {
            ...
            for (i in infoData){
                ...
                str+='<img src="'+uri+'/public/downimg/'+infoData[i]["img_top"]+'" showtopimgwidth="'+infoData[i]["topimg_width"]+'" showgetcodes="'+infoData[i]["getcodes"]+'" width="90" style="opacity:0;"/>';
                ...
                str+='</div>';
                str+='</div>';
                str+='<img src="'+uri+'/public/downimg/'+infoData[i]["img_top"]+'" showtopimgwidth="'+infoData[i]["topimg_width"]+'" width="88" style="border:1px #f5f5f5 solid;"/>';
                str+='</div>';
